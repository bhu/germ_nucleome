...
clrs <- setNames(tableau20(11)[seq(1,11,2)[-3]], samps)
...
ggplot(pd, aes(x = type, y = obs/exp, group = group2)) +
  ...
  ggsave('f2_i.pdf', height = 3.1, width = 3.3)
