...
for s in ['d4c7PGCLC', 'GSC']:
    ...
    fig, axes = plt.subplots(5, 1, sharex=True, figsize=[2.9,4.4], constrained_layout=True,
    ...
    plt.savefig('f3_i_' + s + '.pdf', transparent=True, dpi=600, bbox_inches='tight')
    plt.close()

for s in ['d4c7PGCLC','GSC']:
    reg = 'chr13:112927200-112928000'
    fig, axes = plt.subplots(1, 1, sharex=True, figsize=[3.15,.8], constrained_layout=True,
